...
def update_templates(templates_path, policies_base_path, updated_templates_path):
        ...
        if policies_list:
            for policy_path in policies_list:
                with open(policy_path) as policy:
                    ...
                    new_policy = {'PolicyName': {'Fn::Sub': policy_name + '-${AWS::StackName}'},
...
if __name__ == "__main__":
    ...
    update_templates(TEMPLATES_PATH, POLICIES_BASE_PATH, UPDATED_TEMPLATES_PATH)
